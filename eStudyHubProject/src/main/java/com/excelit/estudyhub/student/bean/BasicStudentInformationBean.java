...
public class BasicStudentInformationBean implements Serializable {
	...
	@Column(name = "student_email_id", length = 20)
	private String studentEmailId;

	public BasicStudentInformationBean() {
		super();
	}
	...
	/**
	 * @param acedamicYear the acedamicYear to set
	 */
	...
	/**
	 * @param classORGrade the classORGrade to set
	 */
	...
	/**
	 * @param studentPlaceOfBirth the studentPlaceOfBirth to set
	 */
	...
	/**
	 * @param studentRace the studentRace to set
	 */
	...
	/**
	 * @param studentLiveWith the studentLiveWith to set
	 */
	...
	/**
	 * @param studentAadharCard the studentAadharCard to set
	 */
	...
	/**
	 * @param studentReligion the studentReligion to set
	 */
	...
	/**
	 * @param studentCaste the studentCaste to set
	 */
	...
	/**
	 * @param studentRTECandidate the studentRTECandidate to set
	 */
	...
	/**
	 * @param studentSiblingsStudyingInSameSchool the studentSiblingsStudyingInSameSchool to set
	 */
	...
	/**
	 * @param studentAddressLine1 the studentAddressLine1 to set
	 */
	...
	/**
	 * @param studentAddressLine2 the studentAddressLine2 to set
	 */
	...
	/**
	 * @param studentAddressLine3 the studentAddressLine3 to set
	 */
	...
	/**
	 * @param studentTownORCityName the studentTownORCityName to set
	 */
	...
	/**
	 * @param studentDistrictORCounty the studentDistrictORCounty to set
	 */
	...
	/**
	 * @param studentCountry the studentCountry to set
	 */
	...
	/**
	 * @param studentZipCodeORPostalCode the studentZipCodeORPostalCode to set
	 */
	...
	/**
	 * @param studentHomePhoneNumber the studentHomePhoneNumber to set
	 */
	...
	/**
	 * @param studentMobileNumber the studentMobileNumber to set
	 */
