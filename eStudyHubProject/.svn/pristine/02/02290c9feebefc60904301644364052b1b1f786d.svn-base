...
private List<BasicStudentInformationBean> basicStudentInformationBeanList;
private List<PreviousSchoolingInfoBean> previousSchoolingInfoBean;



/**
 * @return the basicStudentInformationBeanList
 */
public List<BasicStudentInformationBean> getBasicStudentInformationBeanList() {
	return basicStudentInformationBeanList;
}
/**
 * @param basicStudentInformationBeanList the basicStudentInformationBeanList to set
 */
public void setBasicStudentInformationBeanList(List<BasicStudentInformationBean> basicStudentInformationBeanList) {
	this.basicStudentInformationBeanList = basicStudentInformationBeanList;
}
/**
